 ...
 */
/*! Source: ./src/js/extend/jquery.extend.js */
(function (window, $, undefined) {
    ...
    coreString.isUrlOrIPv4 = function (str) {
        return coreString.isUrl(str) || coreString.isIPv4(str);
    };
    ...
    /**
    * 在jquery-1.11.3中当请求JSON类型的数据时，无结果返回会导致JSON.parse解析出错
    * Author: wu.hao
    * Date: 2016/01/28
    */
    (function() {
        ...
        $.parseJSON = function(data) {
            data = data != '' ? data : '{}';
            return parseJSON.apply(this, [data]);
        };
...
/*! Source: ./src/js/extend/jquery.hotkeys.plugin.js */
/*
