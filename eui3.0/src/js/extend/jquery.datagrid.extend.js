(function ($, undefined) {
    ...
    function initHeaderCellClickMenu(t, opts, exts, cell) {
        ...
        var arrow = $("<span class='s-btn-downarrow datagrid-header-cell-arrow datagrid-header-cell-arrow-fix'>&nbsp;</span>").click(function (e) {
    ...
    var loader = $.fn.datagrid.extensions.loader = function (param, success, error) {
        ...
        $.ajax({
            ...
            success: function (data) { 
                clearFilterData(opts); success(data); 
            },
            error: function () { 
    ...
    var css =
        ...
        ".datagrid-header-cell-arrow-fix { position: static; margin: 0; }" +
