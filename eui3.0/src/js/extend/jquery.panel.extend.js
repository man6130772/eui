(function ($, undefined) {
    ...
    var onResize = function (width, height) {
        ...
        if (!p.panel("inLayout")) {
             ...
             * Author: chen.c1
             * Description: Solve the problem that if the property 'maxHeight' exist, then will be covered by $.fn.panel.extensions.defaults.maxHeight.
             * Modify Start
             */
            var pMaxHeight = p.css('maxHeight');
            ...
            opts.maxHeight = !!pMaxHeight ? parseInt(pMaxHeight) : $.isNumeric(opts.maxHeight) ? opts.maxHeight : defaults.maxHeight;
            /* Modify End */
            var resizable = false;
