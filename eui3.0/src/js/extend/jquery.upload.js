...
(function ($) {
	$.fn.upload = function (options, params) {
		if (typeof options == "string") {
			return $.fn.upload.methods[options](this, params);
		}
		options = options || {};
		return this.each(function () {
			var data = $.data(this, "upload");
			var newOptions;
			if (data) {
				newOptions = $.extend(data.options, options);
				data.opts = newOptions;
			} else {
				newOptions = $.extend({}, $.fn.upload.defaults, $.fn.upload.parseOptions(this), options);
				$.data(this, "upload", {
					options : newOptions
				});
			}
