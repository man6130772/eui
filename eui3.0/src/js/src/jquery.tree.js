...
//		param = param || {};
	...
	function expandNode(target, nodeEl, callback){
		 ...
		 * 		 2016/04/15 17:16:59
		 * Author: chen.c1
		 * Description: 1.avoid the param "state" is "closed" and the children is null, ajax will cyclic loading.
		 * 				2.restore original code, because when "state" is "closed" and "children" is null, request use different param with the same url to request different data.
		 * Modify Start
		 */
		} else {
